...
# Autor: Armando Nava Betancourt  Fecha de la ultima actualizacion del sistema: 27/07/2022
...
def window2():
    ...
    def der6func ():
        ...
        lbl.place(x=940, y=210, width=30, height=30)
        lbl1 = tk.Label(frame3, text=' ! ',image=img1 , bg='green3')
        lbl1.place(x=1010, y=210, width=30, height=30)
        lbl2 = tk.Label(frame3, text=' ! ',image=img2 , bg='green3')
        lbl2.place(x=1020, y=280, width=30, height=30)
        lbl3 = tk.Label(frame3, text=' ! ',image=img3 , bg='green3')
        lbl3.place(x=1155, y=290, width=30, height=30)
        lbl4 = tk.Label(frame3, text=' ! ',image=img4 , bg='green3')
        lbl4.place(x=1120, y=245, width=30, height=30)
    ...
    def izne8fun():
        ...
        lbl = tk.Label(frame3, text=' ! ',image=img0 , bg='green3')
        lbl.place(x=780, y=230, width=30, height=30)
        lbl1 = tk.Label(frame3, text=' ! ',image=img1 , bg='green3')
        lbl1.place(x=840, y=230, width=30, height=30)
        lbl2 = tk.Label(frame3, text=' ! ',image=img2 , bg='green3')
        lbl2.place(x=620, y=300, width=30, height=30)
        lbl3 = tk.Label(frame3, text=' ! ',image=img3 , bg='green3')
        lbl3.place(x=763, y=290, width=30, height=30)
        lbl4 = tk.Label(frame3, text=' ! ',image=img4 , bg='green3')
        lbl4.place(x=655, y=250, width=30, height=30)
        lbl5 = tk.Label(frame3, text=' ! ',image=img5 , bg='green3')
        lbl5.place(x=655, y=350, width=30, height=30)
        lbl6 = tk.Label(frame3, text=' ! ',image=img6 , bg='green3')
        lbl6.place(x=850, y=260, width=30, height=30)
        lbl7 = tk.Label(frame3, text=' ! ',image=img7 , bg='green3')
        lbl7.place(x=960, y=260, width=30, height=30)
        
    def derne8func ():
        global frame3, img0, img1, img2, img3, img4, img5, img6, img7, lbl, lbl1, lbl2, lbl3, lbl4, lbl5, lbl6, lbl7
        lbl = tk.Label(frame3, text=' ! ',image=img0 , bg='green3')
        lbl.place(x=980, y=200, width=30, height=30)
        lbl1 = tk.Label(frame3, text=' ! ',image=img1 , bg='green3')
        lbl1.place(x=1060, y=200, width=30, height=30)
        lbl2 = tk.Label(frame3, text=' ! ',image=img2 , bg='green3')
        lbl2.place(x=1065, y=260, width=30, height=30)
        lbl3 = tk.Label(frame3, text=' ! ',image=img3 , bg='green3')
        lbl3.place(x=1195, y=265, width=30, height=30)
        lbl4 = tk.Label(frame3, text=' ! ',image=img4 , bg='green3')
        lbl4.place(x=1175, y=220, width=30, height=30)
        lbl5 = tk.Label(frame3, text=' ! ',image=img5 , bg='green3')
        lbl5.place(x=1175, y=310, width=30, height=30)
        lbl6 = tk.Label(frame3, text=' ! ',image=img6 , bg='green3')
        lbl6.place(x=860, y=235, width=30, height=30)
        lbl7 = tk.Label(frame3, text=' ! ',image=img7 , bg='green3')
        lbl7.place(x=980, y=235, width=30, height=30)
    
    def izH60 ():
        global frame3, img0, img1, img2, img3, img4, img5, img6, img7, lbl, lbl1, lbl2, lbl3, lbl4, lbl5, lbl6, lbl7
        lbl = tk.Label(frame3, text=' ! ',image=img0 , bg='green3')
        lbl.place(x=820, y=230, width=30, height=30)
        lbl1 = tk.Label(frame3, text=' ! ',image=img1 , bg='green3')
        lbl1.place(x=880, y=230, width=30, height=30)
        lbl4 = tk.Label(frame3, text=' ! ',image=img2 , bg='green3')
        lbl4.place(x=720, y=270, width=30, height=30)
        lbl5 = tk.Label(frame3, text=' ! ',image=img3 , bg='green3')
        lbl5.place(x=820, y=270, width=30, height=30)
        lbl2 = tk.Label(frame3, text=' ! ',image=img4 , bg='green3')
        lbl2.place(x=750, y=240, width=30, height=30)
        lbl3 = tk.Label(frame3, text=' ! ',image=img5 , bg='green3')
    ...
    def izneg10func():
        ...
        lbl = tk.Label(frame3, text=' ! ',image=img0 , bg='green3')
        lbl.place(x=725, y=200, width=30, height=30)
        lbl1 = tk.Label(frame3, text=' ! ',image=img1 , bg='green3')
        lbl1.place(x=790, y=200, width=30, height=30)
        lbl2 = tk.Label(frame3, text=' ! ',image=img2 , bg='green3')
        lbl2.place(x=580, y=270, width=30, height=30)
        lbl3 = tk.Label(frame3, text=' ! ',image=img3 , bg='green3')
        lbl3.place(x=710, y=270, width=30, height=30)
        lbl4 = tk.Label(frame3, text=' ! ',image=img4 , bg='green3')
        lbl4.place(x=600, y=230, width=30, height=30)
        lbl5 = tk.Label(frame3, text=' ! ',image=img5 , bg='green3')
        lbl5.place(x=600, y=310, width=30, height=30)
        lbl6 = tk.Label(frame3, text=' ! ',image=img6 , bg='green3')
        lbl6.place(x=800, y=240, width=30, height=30)
        lbl7 = tk.Label(frame3, text=' ! ',image=img7 , bg='green3')
        lbl7.place(x=910, y=240, width=30, height=30)
    ...
    def derneg10func():
        global frame3, img0, img1, img2, img3, img4, img5, img6, img7, lbl, lbl1, lbl2, lbl3, lbl4, lbl5, lbl6, lbl7, lbl8, lbl9
        lbl= tk.Label(frame3, text=' ! ',image=img0 , bg='green3')
        lbl.place(x=995, y=245, width=30, height=30)
        lbl1 = tk.Label(frame3, text=' ! ',image=img1 , bg='green3')
        lbl1.place(x=1065, y=245, width=30, height=30)
        lbl2 = tk.Label(frame3, text=' ! ',image=img2 , bg='green3')
        lbl2.place(x=1090, y=330, width=30, height=30)
        lbl3 = tk.Label(frame3, text=' ! ',image=img3 , bg='green3')
        lbl3.place(x=1210, y=340, width=30, height=30)
        lbl4 = tk.Label(frame3, text=' ! ',image=img4 , bg='green3')
        lbl4.place(x=1200, y=280, width=30, height=30)
        lbl5 = tk.Label(frame3, text=' ! ',image=img5 , bg='green3')
        lbl5.place(x=1200, y=380, width=30, height=30)
        lbl6 = tk.Label(frame3, text=' ! ',image=img6 , bg='green3')
        lbl6.place(x=870, y=300, width=30, height=30)
        lbl7 = tk.Label(frame3, text=' ! ',image=img7 , bg='green3')
        lbl7.place(x=980, y=300, width=30, height=30)
        lbl8 = tk.Label(frame3, text=' ! ',image=img8 , bg='green3')
        lbl8.place(x=925, y=245, width=30, height=30)
        lbl9 = tk.Label(frame3, text=' ! ',image=img9 , bg='green3')
